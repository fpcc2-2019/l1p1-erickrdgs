...
Verificando a linha que descreve a mediana no boxplot podemos nitidamente notar que a mediana da quantidade média de chuva semanal de JP é maior do que a mediana da quantidade média de chuva semanal em CG. Portanto, juntando as conclusões retiradas utilizando ambas medidas agregadoras da média e mediana, podemos concluir que durante o período de 1995-2019 (com excessão dos anos de 2000 e 2001) a cidade de João Pessoa pode ser considerada uma cidade mais quente em comparação com a cidade de Campina Grande.
